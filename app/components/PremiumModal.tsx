      ...
      <div className="relative bg-white dark:bg-[#0f1c23] rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-[#dae2e7] dark:border-white/10">
        ...
        <div className="px-8 pb-8 text-center">
          ...
          <div className="flex flex-col gap-3">
            <button className="w-full flex items-center justify-center gap-3 bg-primary text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-primary/30 hover:shadow-md transition-shadow">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 20 20"
